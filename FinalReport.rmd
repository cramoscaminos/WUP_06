...
Both race and capital punishment are categorical variable, so  analysis technique is Cat~cat. The plot is bar plot, summary is a cross table, and inference is chi-square test.   
...
From this plot it appears that the white race in more likely to favor capital punishment.  
...
colPerc(table2)
```
From the table it appears that the white race is 67.98% in favor of capital punishment. That is almot 7-3 out of the white individuals in favor of capital punishment.  
...
The question asks if race is a factor that determines if an individual is in favor or against capital punishment. I reject the null hypothesis.  Based on the p-value attitude in regards toward capital punishment is dependent on race. A white person in 2x more likely to be in favor of capital punishment. Black persons are .68 to 1  less in favor of capital punishment.