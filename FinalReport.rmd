...
Both race and capital punishment are categorical variable, so  analysis technique is Cat~cat. The plot is barplot, summary is a cross table, and inference is chi-square test.   
